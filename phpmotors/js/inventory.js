...
function buildInventoryList(data) { 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<tr class="tr-table"><td>${element.invMake} ${element.invModel}</td>`; 
     dataTable += `<td class="td-table"><a href='/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`; 
     dataTable += `<td class="td-table"><a href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
