...
switch ($action) {
    ...
    case 'searchInfo': 
        ...
        //     $search_string = "SELECT * FROM inventory WHERE ";
        //     $display_words = "";

        //     // format each of search keywords into the db query to be run
        //     $keywords = explode(' ', $k);
        //     foreach ($keywords as $word) {
        //         $search_string .= "invDescription LIKE '%" . $word . "%' OR ";
        ...
        $results = getSearch($k);
        //var_dump($results);
        $_SESSION['countResult'] = '<p class="searchResult"> Returned ' . count($results) . ' results for: ' . $k . '</p>';
